<x-app-layout>
    ...
    <div class="overflow-x-auto mx-auto my-12 relative shadow-md sm:rounded-lg bg-white">
        ...
        <div class="p-5 bg-white flex items-center justify-center">
            <a href="{{ route('films.create') }}" class="px-4 py-2 rounded-lg bg-blue-800 hover:opacity-80 text-white">Crear Proyecto</a>
        </div>
        @endcan
        <table class="w-full text-sm text-left text-gray-500 ">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b  hover:bg-gray-50 ">
                    ...
                    <td class="py-4 px-6">
                        <img src="{{ asset('images/'.$film->poster) }}" width="90px" alt="{{$film->poster}}" title="job image">
                    </td>
                    <td class="py-4 px-6">
